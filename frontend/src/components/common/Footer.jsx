    ...
    <footer className="gradient-green text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 className="text-2xl font-bold mb-4">رحيق</h3>
            <p className="text-white/80">متجرك الموثوق للعسل الطبيعي الأصيل</p>
            <div className="flex gap-3 mt-4">
              <a href="#" className="bg-white/20 p-2 rounded-full hover:bg-white/30 transition-all">
          ...
          <div>
            ...
            <ul className="space-y-2 text-white/80">
              ...
              <li><Link to="/offers" className="hover:text-white transition-colors">العروض</Link></li>
        ...
        <div className="border-t border-white/20 pt-8 text-center text-white/80">
          <p>&copy; 2025 رحيق - جميع الحقوق محفوظة</p>
        </div>
      </div>
    </footer>
  )
